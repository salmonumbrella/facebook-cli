...
describe("ads command tree smoke", () => {
  it("dispatches full ads command tree", () => {
    ...
    const commands = [
      ...
      ["ads", "stats", "validate", '{"data":[{"campaign_id":"c1","date":"2026-03-01","impressions":1,"clicks":1,"spend":1,"ctr":1,"cpc":1,"cpm":1,"conversions":0,"conversion_value":0,"cpa":0,"roas":0}] }'],
      ["ads", "stats", "export", '{"data":[{"campaign_id":"c1","date":"2026-03-01","impressions":1,"clicks":1,"spend":1,"ctr":1,"cpc":1,"cpm":1,"conversions":0,"conversion_value":0,"cpa":0,"roas":0}] }', "/tmp/fb-stats.csv"],
      ["ads", "optimize", "validate", '{"campaign":{"name":"T","total_budget":100},"creatives":[{"id":"c1"}],"targeting_options":{"audiences":[{"id":"a1"}]}}'],
      ["ads", "optimize", "create", "123", '{"campaign":{"name":"T","total_budget":100},"creatives":[{"id":"c1"}],"targeting_options":{"audiences":[{"id":"a1"}]}}'],
